...
def main(xyzOut,fname):
    ...
    with open(xyzOut, 'w') as f:
        ...
        unique_atom_names, ions_per_type, atom_types, all_cells, all_coords, all_energies, all_forces = get_frames(fname, step = 10, convergence_check=True)
...
if __name__ == "__main__":
    for fname in sorted(glob.glob('*jdftxout')):
        xyzOut = fname[:-8]+'xyz'
        main(xyzOut,fname)