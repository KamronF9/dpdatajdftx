...
class JDFTXOutFormat(Format):
    ...
    def from_labeled_system(self, file_name, begin=0, step=1, convergence_check=True, FmaxFilter = False, FmaxLim = 20, **kwargs):
        data = {}
        ...
        data['atom_names'], \
            ...
            data['energies'], \
            data['forces'], \
            = dpdata.jdftx.jdftxout.get_frames(file_name, begin=begin, step=step, ml=ml, convergence_check=convergence_check, FmaxFilter = FmaxFilter, FmaxLim = FmaxLim)
